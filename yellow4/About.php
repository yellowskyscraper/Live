    ...
    <section id="contentcontainer">
		<section id="maindetail">
			...
			<div class="large_copy">      
				...
				Well, at first glance, we're a very tall building of many stories that just so happens to have stimulated both the long- and medium-wavelength cone cells of the retina, producing that yellowing effect we have all come to know and love. It's in further inquiry though, the situation begins to complicate, so much so, that our own team can't even produce much more than senseless rambling and insult. To avoid this, <strong>why</strong> is slightly easier to address than <strong>what</strong>, as why we do what we do, or why we aren't doing what we aren't doing, is somewhat agreed upon. You see it isn't that we like to make loads of money at the expense of others, it's not even that we wish to make a difference in this world, it's not even that we desire fame and the admiration of our contemporaries. It's that we're simply people and this is just what me must do, even if we don't understand entirely and even if the process ultimately kills us.<br><br>
