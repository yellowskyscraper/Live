    ...
    <section id="contentcontainer">
		...
		<section id="detail">
			...
			<div class="linkbar">
				<div class="bar"></div>
				<div class="top"></div>
				<a href="data/projects/ReactiveFloor/Practicum_Bayer.pdf" target="blank"><h3>View Full Case Study</h3></a>
			</div>
			
			<div class="article_columns">
				<h2>Bayer Material Sciences: A Reactive Floor Prototype.</h2>
			...
			<img src="data/projects/ReactiveFloor/image1.jpg" alt="Image Description" />
