...
<body onload="load()">
    <div id="wrapper">    
        ...
        <section class="content">
            ...
            <div class="btmspc">
                <img src="images/slides/thesun.jpg" />
            </div><!--end #featured-->
            ...
            <section class="cols">
                ...
                <article class="col1">
                    ...
                    -->
                    <iframe src="https://docs.google.com/a/exploratorium.edu/spreadsheet/embeddedform?formkey=dGRqQzJFMXNuemZxb1JwQjNxd2lMakE6MQ" width="440" height="540" frameborder="1" marginheight="0" marginwidth="0">Loading...</iframe>
				</article>
                
                <article class="col2">
                	<img src="images/slides/satalite.jpg" />
          
                    <div class="boxcallout">
	                    <p>It is we who are the measure of what is strange and miraculous</p>
                    </div>
                </article>
