...
<html lang="en">
<head>
	<title>Site Wide &middot; Yellowskyscraper</title>
...
<p>Spaces are owned or found; they can be empty lots, store fronts, alleyways, community centers, or living rooms.</p>
 
<p>Proposals are murals, exhibitions, performances, or even, innovative experiments that have yet to be thought of. The idea is that these spaces are not only canvases to be drawn on, but micro platforms for community experimentation and innovation.</p>
...
<p>The Detroit Zoo is a micro representation of the Earth's five biogeographic regions, more commonly known as Biomes. Much like a map allows its participant to experience a large amount of geographic data at a glance, a Zoological Park allows a similar experience involving these five Biomes. The Detroit Zoological Park acts as a map to navigate the worlds regions at a glance, despite a vast physical separation.</p>

<p>It was in the nomenclature of maps used to describe the physical terrain and conditions of an area, where the Detroit Zoological Society's system emerged. With the inherit iconography of terrain, a method can be found to distill and represent the worlds five biogeographic realms. The five biomes represent the most basic division of the worlds surface, defined by four constants unique to a region,  climate, fauna, flora and geography.</p>
...
<h1>A Lonely Box</h1>
<p>Studying loneliness.</p>
<p>1986 - Current | Prototype | Interactive Installation</p>

<h2>What if a box could experience loneliness?</h2>

<p>Lonely Box is a part of a larger exploration of loneliness, one in a series of observations and experiments intended to better my understanding of this curious feeling.</p>

<p>In this case, I became interested in the notion that our conscious understanding of the world is limited to, or constrained to our perception of it. The idea that we perceive our surroundings, then rationalize, and it's through this that we build an understanding of our environment and our relationship to it. And since we can never truly escape these bodies of ours, and transcend this perception, we are forever trapped in a universes governed by these ever so temperamental of senses.</p>

<p>This particular exploration was to create a small electronic device that could experience loneliness on its most shallow of levels, company; alone he grows anxious and erratic, accompanied he becomes calm and ordered. The device was granted a single mode to perceive his world; movement, and a single means to expressing that perception; an illuminated and haptic heartbeat.</p>
...
<h1>LOVE WANTED</h1>
<p>A very personal exploration.</p>
...
<h1>Noise</h1>
<p>A series of colored sounds.</p>
<p>July 2011 | Prototype | iPhone Application</p>

<h2>Signal and Noise</h2>

<p>It was the hustle and bustle of everyday life that inspired the development of this little productivity application. It was never knowing when I'd need to concentrate, always being stuck just too far from the peace and quiet of my wood trimmed study. It was the a constant need to focus through the noise of public commotion, it's from this desire that Noise came.</p>
...
<h1>Reactive Floor</h1>
<p>Connections and collaborations.</p>
<p>November 2008 | Small Scale Interactive Installation</p>

<h2>Bayer Material Sciences: <br>A Reactive Floor Prototype</h2>

<p>Bayer came to us in need of a bridge, a bridge to cross the gap between the Industrial Designer and the Material Supplier. The current chain works something like this, the Designer would create, the Engineer would have their say, then, eventually the Material Supplier would become involved. Bayer was interested in informing the designer of new material research in order to potentially influence design earlier on in the process.</p>

<p>Bayer wanted challenge the Manufacturing sector of the production line in order to inspire change and innovation through new materials and techniques. Starting within the Automotive Sector they wished to revamp an entire process. In their eyes, why replace one part to increase efficiency, when you can think holistically and improve the entire automobile drastically.</p>

<p>With collaboration in mind a series of interactive and conceptual promotions were developed to reach out into the creative sector. Ideas ranging from co-branding with artist and designers, to large interactive installations and events, to documentation and tone. Allowing Bayer to reach their hand out into the creative community in order to encourage a relationship. Promotions intended to provoke opportunities to integrate themselves into the creative process. A collaborative position would move Bayer into an active role in the ideation phase, allowing them to contribute to the problem solving process, inviting creative new solutions that might cause them to rethink or develop something entirely new. In effect, facilitating progressive change and ingenuity.</p>

<h2>Prototype 1 of 6:</h2>
...
<p>I tried will power to no avail. I thought that I might hire someone to watch over me, or find a sponsor to keep me on track. No luck. The solution struck me one evening&#151;when I was at my very lowest, sitting there facing five open tabs, all with Facebook on them&#151;that I would use technology to condition myself away from Facebook.</p>
